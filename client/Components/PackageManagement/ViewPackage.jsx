    ...
    const fetchPackage = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8060/packages/package/view/${id}`
        );
  ...
  return (
    <div style={{ margin: '0 auto', height: '800px', marginTop: '100px' }}>
            ...
            <img
              ...
              src={
                typeof photo !== 'undefined'
                  ? require(`../PackageManagement/PackageImages/${photo}`)
                  : 'Error'
              }
      ...
      >
        ...
        >
          <p className="info" style={{ fontWeight: 'bold', fontSize: '25px' }}>
            {pack.packagename}
          </p>
        ...
        >
          ...
          <p className="status">
            ...
            >
              {pack.featured ? 'Available' : 'Unavailable'}
            </p>
          </p>
          <a href="/inquiry">
